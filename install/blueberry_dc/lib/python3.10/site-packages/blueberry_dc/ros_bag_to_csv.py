...
class DataSubscriber(Node):
    def __init__(self):
        ...
        self.csv_file = f'/home/chelse/ros2_ws_ROB599_Project/csv_files/bush_{bush}_branch_{branch}_trial_{trial}.csv'
        self.file_prefix = f'bush_{bush}_branch_{branch}_trial_{trial}'
    ...
    def data_callback(self, msg):
        ...
        if len(matching_files) == 1:
            ...
            height = matching_files[0][31:]  # Slicing from the 24th character to the end
